  ...
  return {
    ...
    configInfo: {
      ...
      schemas: [
        ...
        {
          field: 'cnyMonitor.pushDiffThreshold',
          label: '推送差值阈值',
          helpMessage: '福气值差值 ≤ 此值时推送预警',
          bottomHelpMessage: '更改重启生效, 默认 40000',
          component: 'InputNumber',
        },
        {
          field: 'cnyMonitor.pushTimeThreshold',
          label: '推送时间阈值(秒)',
          helpMessage: '预估到达时间 ≤ 此值时推送预警',
          bottomHelpMessage: '更改重启生效, 默认 240 (4分钟)',
          component: 'InputNumber',
        },
        {
