  ...
  return {
    ...
    configInfo: {
      ...
      schemas: [
        ...
        {
          field: 'cnyMonitor.enable',
          label: '启用',
          helpMessage: '是否启用 B站春节活动福气值监控与推送',
        ...
        {
          field: 'cnyMonitor.pushGroups',
          label: '推送群',
          helpMessage:
            '填写要推送预警的群号, 多个群用英文逗号分隔, 指令也仅在这些群可用',
          bottomHelpMessage: '更改重启生效, 例: 123456,789012',
          component: 'Input',
        },
        {
          field: 'cnyMonitor.scanPages',
          label: '扫描页数',
          helpMessage: '全站扫描 TAB 页数 (1~20)',
          bottomHelpMessage: '更改重启生效, 默认 15',
          component: 'InputNumber',
        },
        {
          field: 'cnyMonitor.scanInterval',
          label: '扫描间隔(秒)',
          helpMessage: '全站慢速扫描间隔',
          bottomHelpMessage: '更改重启生效, 默认 10',
          component: 'InputNumber',
        },
        {
          field: 'cnyMonitor.monitorInterval',
          label: '高频监控间隔(秒)',
          helpMessage: '高频监控检查间隔',
          bottomHelpMessage: '更改重启生效, 默认 3',
          component: 'InputNumber',
        },
        {
          field: 'cnyMonitor.pushDiffStages',
          label: '推送差值阶段',
          helpMessage: '福气值差值达到每个阶段时分别推送预警',
          bottomHelpMessage: '逗号分隔, 如 40000,30000,20000,10000,5000',
          component: 'Input',
        },
        {
          field: 'cnyMonitor.pushTimeStages',
          label: '推送时间阶段(秒)',
          helpMessage: '预估到达时间达到每个阶段时分别推送预警',
          bottomHelpMessage: '逗号分隔, 如 300,180,120,60,30',
          component: 'Input',
        },
        {
          field: 'cnyMonitor.hfDiffThreshold',
          label: '高频监控差值',
          helpMessage: '差值 ≤ 此值时加入高频监控队列',
          bottomHelpMessage: '更改重启生效, 默认 50000',
          component: 'InputNumber',
        },
        {
          field: 'cnyMonitor.hfProgressPct',
          label: '高频监控进度(%)',
          helpMessage: '进度 ≥ 此百分比时加入高频监控队列',
          bottomHelpMessage: '更改重启生效, 默认 80',
          component: 'InputNumber',
        },
        {
          field: 'cnyMonitor.parallelWorkers',
          label: '并发数',
          helpMessage: '并发请求数',
          bottomHelpMessage: '更改重启生效, 默认 15',
          component: 'InputNumber',
